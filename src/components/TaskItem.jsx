...
function TaskItem ({ descrip = 'Any Task', isDone, deleteTask, toggleCheckTask }) {
  return (
    <li className={`p-2 shadow-md flex gap-3 items-center text-gray-800 ${isDone ? 'opacity-50' : ''} rounded-md hover:bg-gray-200`}>
      ...
      <button onClick={deleteTask} className='ml-auto hover:text-red-500 hover:font-bold'><X weight='bold' /></button>
    </li>
  )
}
